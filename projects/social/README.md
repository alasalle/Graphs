...
1. To create 100 users with an average of 10 friends each, how many times would you need to call `addFriendship()`? Why?
  ...
  - It would call addFriendship 500 times. Total friendships is equal to avg # of friends * # of users / 2 (a friendship is between 2 users). So, that's 100 * 10 = 1000 / 2 = 500.
